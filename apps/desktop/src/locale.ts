...
export const en = {
  ...
  aboutMenu: 'About Vaultai-secured-deepseek-harness',
  edit: 'Edit',
  ...
  startupFailed: 'Vaultai-secured-deepseek-harness is unavailable',
  ...
  updateDownloadedTitle: 'Vaultai-secured-deepseek-harness v{version} downloaded',
  ...
  updateTitle: 'Vaultai-secured-deepseek-harness Update',
  updateAvailable: 'An update is available',
  updateDetail: 'Vaultai-secured-deepseek-harness {version}\n\nThis release includes its matching dsh version. The application will restart after installation.',
...
export const zh = {
  application: '应用',
  aboutMenu: '关于 Vaultai-secured-deepseek-harness',
  edit: '编辑',
  menuBar: '应用菜单',
  delete: '删除',
  undo: '撤销',
  ...
  paste: '粘贴',
  selectAll: '全选',
  startupFailed: 'Vaultai-secured-deepseek-harness 无法使用',
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: 'Vaultai-secured-deepseek-harness v{version} 下载完成',
  ...
  updateTitle: 'Vaultai-secured-deepseek-harness 更新',
