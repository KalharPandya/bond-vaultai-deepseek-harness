...
LangString INSTALLER_LAUNCH_FAILED ${LANG_ENGLISH} "Vaultai-secured-deepseek-harness could not be launched. Retry, or clear Launch now and close the installer."
LangString INSTALLER_LAUNCH_FAILED ${LANG_SIMPCHINESE} "无法启动 Vaultai-secured-deepseek-harness。请重试，或取消勾选立即启动后关闭安装程序。"
...
LangString INSTALLER_RUNNING ${LANG_ENGLISH} "Vaultai-secured-deepseek-harness is running. Close the application, then run this installer again."
LangString INSTALLER_RUNNING ${LANG_SIMPCHINESE} "Vaultai-secured-deepseek-harness 正在运行。请先关闭应用，再重新运行安装程序。"
...
LangString INSTALLER_PATH_OWNERSHIP ${LANG_ENGLISH} "Choose an empty folder or the registered Vaultai-secured-deepseek-harness installation folder."
LangString INSTALLER_PATH_OWNERSHIP ${LANG_SIMPCHINESE} "请选择空文件夹，或 Vaultai-secured-deepseek-harness 原来的安装目录。"
