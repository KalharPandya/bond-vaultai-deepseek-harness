/**
 * First-run step for this deployment's own route. Readiness comes from the same
 ...
 * route named by ONBOARDING_ROUTE. The step reuses that page's credential
...
import { findOnboardingRow, onboardingReadiness } from './store.ts'
...
/**
 * Prompt a first-run user for this deployment's credential while no provider
 * can serve requests and that credential is writable.
